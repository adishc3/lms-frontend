...
const InteractiveHero = () => {
    ...
    const animateDotsRef = useRef(null);
    ...
    useEffect(() => {
        const animateDotsInternal = () => {
            ...
            if (!ctx || width === 0) {
                animationFrameId.current = requestAnimationFrame(animateDotsInternal);
                return;
            }
        ...
        animateDotsRef.current = animateDotsInternal;
    ...
    }, [handleResize, handleMouseMove, INTERACTION_RADIUS_SQ]);
