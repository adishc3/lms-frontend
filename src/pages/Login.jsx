        ...
        <Card className="card-animate w-full max-w-sm border-zinc-800 bg-zinc-900/70 backdrop-blur supports-[backdrop-filter]:bg-zinc-900/60">
          ...
          <form className="grid gap-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="/forgot-password" className="text-sm text-zinc-300 hover:text-zinc-100">Forgot password?</a>
            </div>

            {error ? <div className="rounded-2xl bg-red-500/10 px-4 py-3 text-sm text-red-200">{error}</div> : null}

            <Button className="w-full h-10 rounded-lg bg-zinc-50 text-zinc-900 hover:bg-zinc-200" type="submit" disabled={loading}>
          ...
          <CardFooter className="flex items-center justify-center text-sm text-zinc-400">
            ...
            <Link className="ml-1 text-zinc-200 hover:underline" to="/signup">Create one</Link>
          </CardFooter>
        </Card>
      </div>
    </section>
